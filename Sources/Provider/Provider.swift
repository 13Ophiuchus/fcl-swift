...
public extension FCL {
    enum Provider: Equatable, Hashable, CaseIterable {
        ...
        public static let allCases: [FCL.Provider] = [.flowWallet, .blocto, .devWallet]
        ...
        public func endpoint(chainId: Flow.ChainID = fcl.currentEnv) -> String {
            ...
            case .blocto:
                return chainId == .mainnet
                    ? URL(string: "https://flow-wallet.blocto.app/api/flow/authn")!.absoluteString
        ...
        public static func == (lhs: Provider, rhs: Provider) -> Bool {
            lhs.provider(chainId: .mainnet) == rhs.provider(chainId: .mainnet)
        }
...
public protocol FCLStrategy {
    associatedtype T: Encodable

    func execService(service: FCL.Service, request: T?) async throws -> FCL.Response
    func execService(url: URL, method: FCL.ServiceType, request: T?) async throws -> FCL.Response
}

public extension FCLStrategy {
    func execService(service: FCL.Service, request: T? = nil) async throws -> FCL.Response {
