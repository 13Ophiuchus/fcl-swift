...
public extension FCL {
	enum Provider: Equatable, Hashable, @MainActor CaseIterable {
		...
		@MainActor public static var allCases: [FCL.Provider] = [
			.flowWallet,
			.blocto,
			.devWallet
		]

		@MainActor public static func getEnvCases(env: Flow.ChainID = fcl.currentEnv) -> [FCL.Provider] {
